  ...
  if [[ $(uname) == "Darwin" ]] ; then
    ...
    function battery_pct() {
      ...
      # integer i=$(((currentcapacity/maxcapacity) * 100))
			# smart_battery_status=$(system_profiler SPPowerDataType | grep 'State of Charge (%)' | awk '{print $5}')
			# integer i=$(smart_battery_status)
			smart_battery_status=$(pmset -g batt | grep -Eo "\d+%" | cut -d% -f1)
...
prompt_k8s() {
	...
	prompt_segment black green "k8s: ${current_context}"
}
